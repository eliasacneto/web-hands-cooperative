...
const SpecialOffer = () => {
  ...
  return (
    ...
    <div className='bg-service bg-cover text-white w-full p-3 lg:flex lg:justify-center lg:items-center lg:gap-10'>
        ...
        <div>
            ...
            <h2 className='font-bold text-center pt-4 text-[#FDE047] '>Special Offer</h2>

            <h1 className='font-bold text-4xl text-center pb-4 pt-4 lg:text-left'>Exclusive Limited-Time Offer:</h1>
            <h1 className='text-[#FDE047] font-bold text-2xl text-center pb-4 lg:text-left'>GET 20% OFF</h1>
