    ...
    <div>
        ...
        <div className=' text-center'>
            ...
            <div className="max-w-xs bg-white shadow-lg rounded-lg p-6 text-center hover:bg-gray-100 transition-all">
                ...
                <h1 className="text-2xl font-bold mb-2 text-emerald-500 ">House Cleaning</h1>
            ...
            <div className="max-w-xs bg-white shadow-lg rounded-lg p-6 text-center hover:bg-gray-100 transition-all">
                ...
                <h1 className="text-2xl font-bold mb-2 text-emerald-500">Office Cleaning</h1>
                <p className="text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint.</p>
            </div>
            ...
            <div className="max-w-xs bg-white shadow-lg rounded-lg p-6 text-center hover:bg-gray-100 transition-all">
                ...
                <h1 className="text-2xl font-bold mb-2 text-emerald-500">Floor Cleaning</h1>
                <p className="text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint.</p>
            </div>
            ...
            <div className="max-w-xs bg-white shadow-lg rounded-lg p-6 text-center hover:bg-gray-100 transition-all">
                ...
                <h1 className="text-2xl font-bold mb-2 text-emerald-500">Window Cleaning</h1>
                <p className="text-gray-600">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint.</p>
            </div>
            </div>
